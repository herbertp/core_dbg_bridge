...
The Python tools in the `sw/` directory have been adapted to support the LiteX native UART bridge protocol. Use the `-t litex` option to select the LiteX interface.
...
Note: The LiteX SoC is configured with DDR4 starting at `0x00000000` for backwards compatibility.
